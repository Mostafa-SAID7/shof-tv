  ...
  template: `
    <footer class="border-t border-border bg-card/50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-16">
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div class="col-span-2 md:col-span-4 lg:col-span-1 mb-4 lg:mb-0">
            <a href="#" class="flex items-center gap-2 mb-4">
              ...
              <span class="text-lg font-display font-bold text-foreground"
                >ShofTV</span
              >
            </a>
            <p class="text-sm text-muted-foreground leading-relaxed max-w-xs">
              Your gateway to local entertainment, live TV, and premium streaming
              content. Fully licensed. Always legal.
            </p>
            ...
            <div class="flex items-center gap-3 mt-5">
              <a
                *ngFor="let social of socials"
                [href]="social.href"
                class="w-9 h-9 rounded-lg bg-secondary flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-secondary/80 transition-colors"
        ...
        <!-- Bottom bar -->
        <div
          class="mt-12 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4"
        >
          <p class="text-xs text-muted-foreground">
            &copy; 2026 ShofTV. All rights reserved. All content is fully licensed.
          </p>
